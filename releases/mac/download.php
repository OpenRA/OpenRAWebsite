...
<body>
	...
	<div id="main">
		...
		<div id="singlecolumn">
			<h2>Downloading OpenRA for Mac OS X</h2>
			<p>
				Thank you for downloading OpenRA for Mac OS X. Your download will begin in 10 seconds.
				Click <?php print("<a href=\"$target\">here</a>"); ?> if it does not begin.
			</p>
			<p>
				Please be aware that OpenRA requires an Intel Mac running OS X 10.5 (Leopard) or higher.
			</p>
			<p>
				When trying to report a crash to the developers, please include your exception.log file in your report. 
				It can be found in ~/Library/Application Support/OpenRA/Logs
			</p>
			<p>
